(() => {
  ...
  const dictionary = {
    ...
    "启动当前方案规划求解": "Start current scenario planning solve",
    "启动当前方案评估": "Start current scenario evaluation",
    "将当前方案排队": "Queue current scenario",
    "将当前评估任务排队": "Queue current evaluation task",
    "从队列中移出当前方案": "Remove current scenario from queue",
    "从队列中移出当前评估任务": "Remove current evaluation task from queue",
    "未计算": "Not Calculated",
    "排队中": "Queued",
    "计算中": "Calculating",
    "完成计算": "Completed",
    ...
    "优先求解器": "Preferred Solver",
    "建模接口方式": "Modeling Interface",
    "自动选择": "Automatic Selection",
    "CVXPY通用接口": "CVXPY General Interface",
    "优化求解器原生接口": "Solver Native Interface",
    "当前接口不可用": "Unavailable for Current Interface",
    "（当前接口不可用）": " (Unavailable for Current Interface)",
    ...
    "电储能平衡模式": "Electrochemical Storage Balance Mode",
    "日内平衡": "Daily Balance",
    "周内平衡": "Weekly Balance",
    "月度平衡": "Monthly Balance",
    "年度平衡": "Annual Balance",
    "不闭环": "No Cycle Closure",
    ...
    "是否考虑扰动后平衡约束相关参数": "Post-Disturbance Balance Constraint Related Parameters",
    "是否考虑频率安全约束相关参数": "Frequency Security Constraint Related Parameters",
    ...
    "保存参数失败：": "Failed to save parameters: ",
    "时序数据未加载，无法保存": "Time series data is not loaded, cannot save",
    "后台返回数据为空": "Backend returned empty data",
    ...
    "气象数据坐标与年份": "Weather data coordinates and year",
    "正在解析地点...": "Resolving place...",
    "地点已更新": "Place updated",
    "地点解析失败": "Failed to resolve place",
    ...
    "定位": "Locate",
    "请输入地名": "Please enter a place name",
    "正在获取坐标...": "Getting coordinates...",
    "正在定位...": "Locating...",
    "根据地名查找坐标，或点击地图选点。": "Find coordinates by place name, or click the map to select a point.",
    "地图坐标": "Map coordinates",
    "输入坐标": "Entered coordinates",
    "坐标已填入": "Coordinates filled",
    "气象曲线预览": "Weather Curve Preview",
    "气象统计": "Weather Statistics",
    "气象数据已预览，请确认后更新主页面": "Weather data preview is ready. Confirm to update the main page.",
    "请先获取气象数据并确认预览曲线": "Please fetch weather data and review the preview curves first",
    "获取气象后显示风、光、温曲线预览": "Weather preview curves for wind, solar, and temperature will appear after fetching weather data",
    "保存气象坐标失败": "Failed to save weather coordinates",
    "纬度": "Latitude",
    "经度": "Longitude",
    "-90 到 90": "-90 to 90",
    "-180 到 180": "-180 to 180",
    "当前年之前": "Before the current year",
    "纬度范围应为 -90 到 90": "Latitude must be between -90 and 90",
    "经度范围应为 -180 到 180": "Longitude must be between -180 and 180",
    ...
    "表格显示": "Table View",
    "柱图对比": "Bar Comparison",
    "年度统计显示方式": "Annual Statistics Display Mode",
    ...
    "最低频率": "Lowest Frequency",
    "频率指标": "Frequency Metrics",
    "分时曲线": "Time Curve",
    "高频曲线": "High Frequency Curve",
    "低频曲线": "Low Frequency Curve",
    "柴发开机总容量": "Diesel Online Capacity",
    "新能源总出力": "Total Renewable Output",
    "查询": "Query",
    "月/日": "Month/Day",
    "年": "Year",
    "月": "Month",
    ...
    "关闭": "Close",
    "打开文件": "Open File",
    "风速生成": "Generate Wind Speed",
    "光照生成": "Generate Solar",
    "正在导入负荷文件": "Importing load file",
    "正在导入风速文件": "Importing wind speed file",
    "正在导入太阳辐射文件": "Importing solar irradiance file",
    "负荷文件导入成功，请检查预览后点击确定。": "Load file imported. Please check the preview and click OK.",
    "负荷文件导入失败：": "Load file import failed: ",
    "风速文件导入失败：": "Wind speed file import failed: ",
    "光照文件导入失败：": "Solar file import failed: ",
    "负荷文件已导入为原始曲线，请点击生成负荷曲线。": "Load file imported as the source curve. Click Generate Load Curve.",
    "风速文件已导入为原始曲线，请点击生成风速曲线。": "Wind speed file imported as the source curve. Click Generate Wind Speed Curve.",
    "光照文件已导入为原始曲线，请点击生成光照曲线。": "Solar file imported as the source curve. Click Generate Solar Curve.",
    "原始负荷曲线已载入，请点击生成负荷曲线。": "Source load curve loaded. Click Generate Load Curve.",
    "原始风速曲线已载入，请点击生成风速曲线。": "Source wind speed curve loaded. Click Generate Wind Speed Curve.",
    "原始光照曲线已载入，请点击生成光照曲线。": "Source solar curve loaded. Click Generate Solar Curve.",
    "正在载入原始负荷曲线...": "Loading source load curve...",
    "请选择负荷文件": "Please select a load file",
    "请先选择风速文件": "Please select a wind speed file first",
    "请先选择光照文件": "Please select a solar file first",
    ...
    "生成风速曲线": "Generate Wind Speed Curve",
    "生成光照曲线": "Generate Solar Curve",
    "保存模板": "Save Template",
    ...
    "风速曲线已生成，请检查预览后点击确定。": "Wind speed curve generated. Please check the preview and click OK.",
    "光照曲线已生成，请检查预览后点击确定。": "Solar curve generated. Please check the preview and click OK.",
    "请先生成负荷曲线": "Please generate or import a load curve first",
    "负荷曲线已确认，请保存方案": "Load curve confirmed. Please save the scenario",
    "风速曲线已确认，请保存方案": "Wind speed curve confirmed. Please save the scenario",
    "光照曲线已确认，请保存方案": "Solar curve confirmed. Please save the scenario",
    "负荷生成已取消": "Load generation canceled",
    "风速生成已取消": "Wind speed generation canceled",
    "光照生成已取消": "Solar generation canceled",
    "负荷最大值": "Load Max",
    "负荷最小值": "Load Min",
    "负荷平均值": "Load Average",
    "风速最大值": "Wind Speed Max",
    "风速最小值": "Wind Speed Min",
    "风速平均值": "Wind Speed Average",
    "光照最大值": "Solar Max",
    "光照最小值": "Solar Min",
    "光照平均值": "Solar Average",
    "指定模式": "Mode",
    ...
    "修改前": "Before",
    "修改后": "After",
    "风速曲线已调整，请检查预览后点击确定。": "Wind speed curve adjusted. Please review the preview and confirm.",
    "光照曲线已调整，请检查预览后点击确定。": "Solar curve adjusted. Please review the preview and confirm.",
    "确定": "OK",
    "取消": "Cancel",
  ...
  function partialTranslations(map) {
    return Array.from(map.entries()).filter(([key]) => key.length > 1).sort((left, right) => right[0].length - left[0].length);
  }
