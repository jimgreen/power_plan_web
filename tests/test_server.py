...
class PowerPlanServerTest(unittest.TestCase):
    ...
    def test_task_page_splits_task_types_and_supports_resizing(self):
        ...
        self.assertIn("if (!taskState.evaluationSchemeFilter)", script)
        self.assertIn('task.task_type_key === "evaluation"', script)
        ...
        self.assertIn('section.querySelector(".task-table table")', script)
        self.assertIn('section.querySelector(".task-empty")', script)
        self.assertIn("optimizationHeight = optimizationDesiredHeight", script)
        self.assertNotIn("remainingHeight", script)
        self.assertNotIn("totalDesiredHeight <= availableHeight", script)
    ...
    def test_comparison_page_has_tabs_tables_curves_and_result_selectors(self):
        ...
        self.assertIn("assets/result_curves.js", html)
        self.assertIn("assets/comparison.js?v=20260530-axis-range-controls", html)
        self.assertIn("assets/result_curves.js?v=20260530-axis-range-controls", html)
        ...
        self.assertIn("grid-template-rows: auto auto minmax(0, 1fr)", annual_comparison_card_css)
    ...
    def test_frequency_8760_curve_board_exposes_requested_metric_series(self):
        ...
        self.assertIn("grid-template-rows: auto minmax(0, 1fr) auto", frequency_time_chart_css)
